    ...
    <aside className="sidebar" style={{position: 'relative'}}>
      {toast && (
        <div style={{
          ...
          borderRadius: '8px', fontSize: '0.875rem', textAlign: 'center',
      ...
      <div className="sidebar-header">
        <span style={{color: "var(--accent-color)"}}>●</span> Fireflies Clone
      </div>
      <nav className="sidebar-nav">
        ...
        <Link href="/action-items" className="nav-item">
        ...
        <div style={{marginTop: 'auto', display: 'flex', flexDirection: 'column', gap: '5px'}}>
          ...
          <a href="#" className="nav-item" onClick={(e) => handleComingSoon(e, 'Profile')}>
